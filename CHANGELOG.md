...
## [2026-03-08] – Documentation & Configuration
...
- **`README.md`** — The repository had no README file. A full project README was created covering:
  ...
  - Contact information
- **`CHANGELOG.md`** — This file. Tracks all notable changes to the project.

### Fixed
- **`.env.example`** — The file incorrectly listed a `MONGODB_URI` connection string (for MongoDB),
  even though the backend (`server.js`) exclusively uses **Firebase Admin SDK**. The file now lists
